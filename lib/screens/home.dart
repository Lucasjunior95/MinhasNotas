...
class _MyHomePageState extends State<MyHomePage> {
  ...
  void initState() {
    super.initState();
    NotasDatabase.db.init();
    setNotesFromDB();
  }

  setNotesFromDB() async {
    print("Notas de conjunto inseridas");
    var fetchedNotes = await NotasDatabase.db.getNotesFromDB();
    setState(() {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      floatingActionButton: FloatingActionButton.extended(
        ...
        label: Text('Adicionar Nova Nota'.toUpperCase()),
        icon: Icon(Icons.add),
      ),
          ...
          GestureDetector(
            ...
            child: AnimatedContainer(
              ...
              child: Icon(
                ...
                color: isFlagOn ? Colors.white : Colors.grey,
              ),
              decoration: BoxDecoration(
                  ...
                  border: Border.all(
                    width: isFlagOn ? 2 : 1,
                    color:
                        isFlagOn ? Colors.blue.shade700 : Colors.grey,
                  ),
